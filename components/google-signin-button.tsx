...
export function GoogleSignInButton({
  ...
  // Fallback button when Google SDK is not available
  if (!isGoogleLoaded && !process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID) {
    return (
      <Button type="button" variant="outline" className="w-full h-11 border-2" disabled={true}>
