...
const FavoritesHeader = () => {
  ...
  return (
    <motion.header
      ...
      className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl md:border-b md:border-slate-200/50"
    >
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        >
          {[
            ...
            <Card key={index} className="p-6 bg-white/80 backdrop-blur-sm border-0 hover:shadow-lg transition-all duration-300">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <Card className="p-12 text-center bg-white/60 border-2 border-dashed border-slate-300">
            <Heart className="h-16 w-16 text-slate-300 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-slate-900 mb-2">{t('empty.title')}</h3>
            <p className="text-slate-600 mb-6">{t('empty.description')}</p>
            <Button
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              className="border-red-200 hover:bg-red-50 px-8 py-3 text-lg"
            >
